...
public class EMSelectedGoodsRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<List<EMGoodsTo2.RowsBean>> rowsBeans;
    ...
    public EMSelectedGoodsRvAdapter(Context context, List<List<EMGoodsTo2.RowsBean>> rowsBeans) {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setItem(int position) {
            List<EMGoodsTo2.RowsBean> list = rowsBeans.get(position);
