...
import com.scy.dingtu_handset.di.component.DaggerLoginComponent;
import com.scy.dingtu_handset.mvp.contract.LoginContract;
import com.scy.dingtu_handset.mvp.presenter.LoginPresenter;
...
public class LoginActivity extends BaseActivity<LoginPresenter> implements LoginContract.View {
    ...
    ImageView ivShowPwd;
    @BindView(R.id.cbIsRememberPass)
    CheckBox cbIsRememberPass;
    ...
    @OnClick({R.id.iv_clean_phone, R.id.clean_password, R.id.iv_show_pwd, R.id.cbIsRememberPass, R.id.btn_login})
    ...
    @Override
    public void onLogin(UserInfoTo userInfoTo) {
