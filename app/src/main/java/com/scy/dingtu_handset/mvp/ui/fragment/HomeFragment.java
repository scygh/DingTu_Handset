package com.scy.dingtu_handset.mvp.ui.fragment;
...
import com.scy.dingtu_handset.app.entity.HomeIndex;
import com.scy.dingtu_handset.app.utils.FillUtil;
import com.scy.dingtu_handset.app.utils.SpUtils;
import com.scy.dingtu_handset.di.component.DaggerHomeComponent;
import com.scy.dingtu_handset.mvp.contract.HomeContract;
import com.scy.dingtu_handset.mvp.presenter.HomePresenter;
import com.scy.dingtu_handset.mvp.ui.activity.AutoActivity;
import com.scy.dingtu_handset.mvp.ui.activity.CloseActivity;
...
import com.scy.dingtu_handset.mvp.ui.activity.RefundActivity;
...
public class HomeFragment extends BaseFragment<HomePresenter> implements HomeContract.View {
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        addDisposabe(getData(new DisposableObserver<HomeIndex>() {
            ...
            public void onNext(HomeIndex homeIndex) {
                List<HomeIndex.Pub_Dictionary_Item> items = homeIndex.pub_Dictionary_Item;
                if (items != null && items.size() > 0)
                    for (HomeIndex.Pub_Dictionary_Item item : items) {
    ...
    public void addItem(HomeIndex.Pub_Dictionary_Item item) {
        if (item == null) {
            return;
        }
    ...
    View.OnClickListener MenuItem_Click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            HomeIndex.Pub_Dictionary_Item item = (HomeIndex.Pub_Dictionary_Item) v.getTag();
            ...
            if (item != null) {
                ...
                if (item.ITEM_CODE.equals("1")) {
                    ...
                    getActivity().startActivity(intent);
                }else if (item.ITEM_CODE.equals("13")) {
                    intent.setClass(getActivity(), ScanTakeFoodActivity.class);
                    getActivity().startActivity(intent);
                } else {
