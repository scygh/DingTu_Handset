...
import com.scy.dingtu_handset.di.component.DaggerFaceComponent;
import com.scy.dingtu_handset.mvp.contract.FaceContract;
import com.scy.dingtu_handset.mvp.presenter.FacePresenter;
...
public class FaceActivity extends BaseActivity<FacePresenter> implements FaceContract.View {
    ...
    private void startScanActivity() {
        ...
        Intent intent = new Intent(FaceActivity.this, ZXingScanActivity.class);
