...
public class TaskParams {
     ...
     * @return The truth.
     * @throws HttpException if the value is not a Boolean or the String "true" or
     *                       "false".
     */
     ...
     * @throws HttpException if the key is not found or if the value is not a Number
     ...
     * @throws HttpException if the key is not found or if the value cannot be converted
     *                       to an integer.
     */
