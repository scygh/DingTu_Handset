...
import com.scy.dingtu_handset.app.utils.DisplayUtil;
...
//                    });
        ...
        SpeechUtility.createUtility(application, SpeechConstant.APPID + "=12345678");
...
//        UMConfigure.init(Context context, String appkey, String channel, int deviceType, String pushSecret);
    ...
    private void initDisplayOpinion(Application application) {
        DisplayMetrics dm = ArmsUtils.getResources(application).getDisplayMetrics();
